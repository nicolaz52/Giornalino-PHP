    ...
    <head>
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          ...
          <a class="btn-close" style="background-color: white;" href="page_AccManager.php"></a>
        </div>
      </nav> 
...
session_start();
        ...
        $sql = "SELECT titolo, riassunto_articolo, id_articolo FROM articoli WHERE autore = $autore;";
            ...
            while($row = $result->fetch_assoc()) {
              ...
              echo "<div class='card' style='width: 50rem;'>";
                echo "<div class='card-body'>";  
                  ...
                  echo "<a href='articolo.php?id_articolo = $art' class='btn btn-primary'>Vai all articolo</a>";
                echo "</div>";
              echo "</div>";
            }         
