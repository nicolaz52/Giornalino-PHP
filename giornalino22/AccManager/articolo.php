...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      echo"<a class='navbar-brand'>READING MOMENT</a>";
      echo"<div class='collapse navbar-collapse' id='navbarSupportedContent'>";
      echo"</div>";
      echo"<a class='btn-close' style='background-color: white;' href='articoli.php'></a>";
      echo"</div>";
      echo"</nav>";
    ...
    session_start();
        ...
        $sql = "SELECT titolo, testo_articolo FROM articoli WHERE id_articolo = $art";
