...
<html lang="en">
  <head>
    ...
    <title>Giornalino Account Manager</title>
  </head>
  <body>
    ...
    <head>
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          ...
          <a class="btn btn-warning" href="articoli.php" role="button">I miei Articoli</a>
          <a class="btn btn-warning" href="registration/registration.html" role="button">Nuovo Account</a>
